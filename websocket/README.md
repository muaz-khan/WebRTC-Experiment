...
The specialty of PubNub oriented WebSocket implementation is that it doesn't require any server side installation or work. You just need an HTML editor and a web browser!
...
## JavaScript code from [5-websocket.js](https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket/5-websocket.js)!

```javascript
var pubnub = { channel: 'WebRTC Experiments Room' };
...
pubnub.init = function (pub) {
    ...
    socket = new WebSocket('wss://pubsub.pubnub.com/demo/demo/' + pubnub.channel);
...
## [JavaScript code](https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket/3-rtc.js) calling WebRTC APIs from JS-Wrapper [RTCPeerConnection.js](https://github.com/muaz-khan/WebRTC-Experiment/tree/master/RTCPeerConnection.js)!
...
## [JavaScript code](https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket/2-rtc-functions.js) handling [RTCWeb](https://github.com/muaz-khan/WebRTC-Experiment/tree/master/RTCPeerConnection.js) stuff!
