...
-. webrtc-everywhere supported added for Safari & IE11.
...
(function() {
        ...
        function newPrivateSocket(_config) {
            ...
            var peerConfig = {
                ...
                onaddstream: function(stream, session) {
                    ...
                    if (!pluginRTC && !stream.getVideoTracks().length)
            ...
            function afterRemoteStreamStartedFlowing(args) {
                ...
                var streamedObject = {
                    ...
                    blobURL: pluginRTC ? false : mediaElement.mozSrcObject ? URL.createObjectURL(stream) : mediaElement.src,
                    type: 'remote',

                    extra: _config.extra,
                    userid: _config.userid,

                    isVideo: pluginRTC ? false : stream.getVideoTracks().length > 0,
                    isAudio: pluginRTC ? false : !stream.getVideoTracks().length && stream.getAudioTracks().length > 0,
                    isScreen: stream.isScreen,
        ...
        return {
            ...
            init: function() {
                ...
                this.connection.onaddstream = function(e) {
                    log('onaddstream', pluginRTC ? e.stream : toStr(e.stream));
            ...
            addStream: function(stream) {
                ...
                log('attaching stream:', stream.streamid, pluginRTC ? stream : toStr(stream));
    ...
    function setDefaults(connection) {
        ...
        if (!pluginRTC && DetectRTC.screen.onScreenCapturingExtensionAvailable) {
    ...
    window.onPluginRTCInitialized = function(pluginRTCObject) {
        ...
        log(pluginRTC ? 'Java-Applet' : 'ActiveX', 'plugin has been loaded.');
    };
