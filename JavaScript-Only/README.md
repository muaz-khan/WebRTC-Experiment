...
[WebRTC Experiment](https://webrtc-experiment.appspot.com/javascript/) that uses Pubnub modern JavaScript APIs for signaling to make a realtime handshake! It is reliable and faster as compare to traditional XHR model!
